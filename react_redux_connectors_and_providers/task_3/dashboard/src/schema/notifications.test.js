...
describe('normalizedData', () => {
  ...
  it('has the correct `user` entity for id `5debd764a7c57c7839d722e9`', () => {
    const expectedUser = {
      age: 25,
  ...
  it('has the correct `messages` entity for id `efb6c485-00f7-4fdf-97cc-5e12d14d6c41`', () => {
  ...
  it('has the correct `notifications` entity for id `5debd7642e815cd350407777`', () => {
